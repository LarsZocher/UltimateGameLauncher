...
public class ResizeHelper {
	...
	public static void addResizeListener(Stage stage) {
		addResizeListener(stage, 0, 0, Double.MAX_VALUE, Double.MAX_VALUE, true);
	}
	
	public static void addResizeListener(Stage stage, double minWidth, double minHeight, double maxWidth, double maxHeight, boolean allowResize) {
		ResizeListener resizeListener = new ResizeListener(stage, allowResize);
	...
	static class ResizeListener implements EventHandler<MouseEvent> {
		...
		public ResizeListener(Stage stage, boolean allowResize) {
			this.stage = stage;
